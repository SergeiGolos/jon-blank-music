...
const videosData: VideoData[] = [
  {
    ...
    description:
      "Solo tenor saxophone performance showcasing Jon's smooth tone and improvisational skills.",
    videoLink:
      "https://www.youtube.com/results?search_query=jon+blanck+tennessee+whiskey+saxophone",
  ...
  },
  {
    ...
    videoLink:
      "https://www.youtube.com/results?search_query=funkee+boy+love+never+felt+so+good+jon+blanck",
    group: "Video Performances",
    image:
  ...
  },
  {
    ...
    description:
      "High-energy funk performance showcasing Jon's groove and versatility.",
    videoLink:
      "https://www.youtube.com/results?search_query=sons+of+funk+flashlight+jon+blanck",
    group: "Video Performances",
  },
  {
    title: "Verve Jazz Ensemble",
    description:
      "Chart-topping jazz ensemble featuring Jon as Music Director and featured soloist.",
    videoLink:
      "https://www.youtube.com/results?search_query=verve+jazz+ensemble",
  ...
  },
  {
    ...
    description:
      "Traditional big band performances showcasing Jon's section and solo work.",
    videoLink:
      "https://www.youtube.com/results?search_query=moonlighters+big+band+jon+blanck",
    group: "Ensemble Performances",
    image:
      "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=640&h=360&fit=crop",
  },
  {
    ...
    description:
      "Afro-Rican Jazz Quintet featuring Jon's Latin jazz expertise.",
    videoLink:
      "https://www.youtube.com/results?search_query=jon+garcia+clave+afro+rican+jazz",
    group: "Ensemble Performances",
  },
];
