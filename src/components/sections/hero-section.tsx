...
export default component$(() => {
  return (
    <section id="hero" class="text-center py-20">
      <div class="flex flex-row items-center gap-12 max-w-5xl mx-auto">
        {/* Profile Image */}
        <div class="flex-shrink-0">
          <div class="relative">
            <div class="w-64 h-64 rounded-full shadow-2xl border-4 border-amber-500/30 bg-gradient-to-br from-amber-500/40 to-blue-600/40 backdrop-blur-sm flex items-center justify-center overflow-hidden">
              <img
